...
import { Clock, Video, MessageCircle, Star, Calendar, User } from 'lucide-react-native';
...
export const SessionsList: React.FC<SessionsListProps> = ({ sessions, loading }) => {
    ...
    <TouchableOpacity style={styles.sessionCard}>
        ...
        <View style={styles.tutorInfo}>
          ...
          <View style={styles.sessionDetails}>
            ...
            <View style={styles.timeContainer}>
              <Calendar size={14} color={colorScheme === 'dark' ? '#9ca3af' : '#6b7280'} />
              <Text style={styles.timeText}>{formatDateTime(item.scheduledTime)}</Text>
      ...
      <View style={styles.cardFooter}>
        <TouchableOpacity style={styles.messageButton}>
          <MessageCircle size={16} color={colorScheme === 'dark' ? '#e5e7eb' : '#374151'} />
