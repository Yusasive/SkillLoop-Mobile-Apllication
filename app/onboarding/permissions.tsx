  ...
  const [permissions, setPermissions] = useState<Permission[]>([
    {
      ...
      description:
        'Get notified about session updates, messages, and important events',
      required: false,
      granted: false,
    },
    {
      ...
      title: 'Camera Access',
      description:
        'Take photos for your profile and share content during sessions',
      required: false,
      granted: false,
    },
    {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.description}>
          SkillLoop needs these permissions to provide the best learning
          experience
        </Text>
