  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.endCallButton} onPress={handleEndSession}>
      ...
      <View style={styles.videoContainer}>
        ...
        <View style={styles.selfVideo}>
          <Text style={styles.selfVideoPlaceholder}>You</Text>
        </View>
      </View>
          ...
          {progress.map((milestone) => (
            ...
            >
              {milestone.completed ? (
                ...
                <Square size={20} color={colorScheme === 'dark' ? '#6b7280' : '#9ca3af'} />
              )}
              <Text style={[
